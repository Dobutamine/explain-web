...
export class BloodValve extends BaseModelClass {
  // static properties
  ...
  constructor(model_ref, name = "") {
    ...
    this.no_flow = false; // flags whether flow is allowed across this valve
    this.no_back_flow = true; // flags whether backflow is allowed across this valve
