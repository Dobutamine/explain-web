...
/*
Arterioles have just as arteries three distinct layers (tunics) but with different proportions:
...
- Their muscle layer is proportionally thicker relative to their diameter
- Have less elastic tissue than larger arteries
- Function as resistance vessels that regulate blood flow to tissues
- Can constrict or dilate significantly based on neural and chemical signals

Play a critical role in controlling blood pressure and distributing blood flow to different tissues based on metabolic needs

The smooth muscle in both vessels (arteries and arterioles) responds to various signals (neural, hormonal, local metabolites) 
to adjust blood flow throughout the body, making them crucial for maintaining proper perfusion to tissues.

Much smaller vessels (10-100μm diameter)
Terminal branches of arteries before capillaries
Proportionally more smooth muscle relative to diameter
Main function: Regulate blood flow to tissues (resistance vessels)
Densely innervated by sympathetic nerves
Primary site of peripheral resistance control
Can dramatically change blood flow to tissues through constriction/dilation
...
export class Arteriole extends BloodCapacitance {
  // static properties
