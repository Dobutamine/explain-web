...
export class Ecls {
  ...
  build_tubing_in() {
    ...
    this._tubing_in = new BloodCapacitance(
      this._model_engine,
      "_tubing_in",
      "BloodCapacitance"
    );
  ...
  build_tubing_out() {
    // define a blood capacitance which represents the tubing on the inlet side
    this._tubing_out = new BloodCapacitance(
      this._model_engine,
      "_tubing_out",
      "BloodCapacitance"
    );
  ...
  build_oxy() {
    // define a blood capacitance which represents the tubing on the inlet side
    this._oxy = new BloodCapacitance(
      this._model_engine,
      "_oxy",
      "BloodCapacitance"
    );
  ...
  build_blood_part() {
    ...
    this._pump = new BloodPump(this._model_engine, "_pump", "BloodPump");
    ...
    // connect the parts
    this._drainage_cannula = new BloodResistor(
      this._model_engine,
      "_drainage_cannula",
      "BloodResistor"
    );
    ...
    this._tubing_in_pump = new BloodResistor(
      this._model_engine,
      "_tubing_in_pump",
      "BloodResistor"
    );
    ...
    this._pump_oxy = new BloodResistor(
      this._model_engine,
      "_pump_oxy",
      "BloodResistor"
    );
    ...
    this._oxy_tubing_out = new BloodResistor(
      this._model_engine,
      "_oxy_tubing_out",
      "BloodResistor"
    );
    ...
    this._return_cannula = new BloodResistor(
      this._model_engine,
      "_return_cannula",
      "BloodResistor"
    );
