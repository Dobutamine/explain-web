        ...
        <div class="col-3">
          ...
          >
            ...
            <q-tab name="brain"
              ...
              ><q-tooltip>edit nervous system</q-tooltip>
            </q-tab>
            <q-tab name="other_systems"
              ><q-icon name="fa-solid fa-bars" size="xs"></q-icon
              ><q-tooltip>edit other systems</q-tooltip>
            </q-tab>
            <q-tab name="scaling"
              ><q-icon name="fa-solid fa-weight-scale" size="xs"></q-icon
              ><q-tooltip>global moddel scaling</q-tooltip>
            </q-tab>
          </q-tabs>
          ...
          >
            ...
            <q-tab-panel name="circulatory_system">
              ...
              >
                <div
                  v-for="item in state.configuration.enabled_controllers
                    .circulation"
                >
                  <NiceController
                    :config="state.configuration.controllers[item]"
                  ></NiceController>
                </div>
              </q-scroll-area>
            </q-tab-panel>
            ...
            <q-tab-panel name="brain">
              ...
              >
                <div
                  v-for="item in state.configuration.enabled_controllers.brain"
                >
                  <NiceController
                    :config="state.configuration.controllers[item]"
                  ></NiceController>
            ...
            <q-tab-panel name="other_systems">
              ...
              >
                <div
                  v-for="item in state.configuration.enabled_controllers.others"
                >
                  <NiceController
                    :config="state.configuration.controllers[item]"
                  ></NiceController>
            ...
            <q-tab-panel name="scaling">
              ...
              >
                <NiceController
                  :config="state.configuration.controllers.scaler_controller"
                ></NiceController>
                <div class="row">
                  <q-btn
                    class="q-mr-md q-ml-md col"
                    color="negative"
                    @click="updateScale"
                    >SCALE PATIENT</q-btn
                  >
          ...
          >
            <q-tab-panel name="numerics">
              ...
              >
                ...
                >
                  <NumericsComponent
                    :title="state.configuration.monitors[enabled_numeric].title"
                    :collapsed="
                      state.configuration.monitors[enabled_numeric].collapsed
                    "
                    :parameters="
                      state.configuration.monitors[enabled_numeric].parameters
                    "
                  ></NumericsComponent>
                </div>
              </q-scroll-area>
    ...
    updateWatchlist() {
      ...
      Object.keys(this.state.configuration.enabled_monitors).forEach(
        (enabled_monitor_category) => {
          this.state.configuration.enabled_monitors[
            enabled_monitor_category
          ].forEach((monitor) => {
