export class Breathing {
  ...
  constructor(model_ref, name = "") {
    ...
    this.dependencies = [];
    this.targets = [];
    this.breathing_enabled = true;
    this.minute_volume_ref = 0.64; // in L/min/kg
    this.minute_volume_ref_factor = 1.0;
    this.minute_volume_ref_scaling_factor = 1.0;
    this.vt_rr_ratio = 0.03; // in L/bpm/kg
    this.vt_rr_ratio_factor = 1.0;
    this.vt_rr_ratio_scaling_factor = 1.0;
    this.rmp_gain_max = 12.0;
    this.ie_ratio = 0.3;
    this.is_intubated = false;
    this.tv_source = "MOUTH_DS";
    this.mv_ans_factor = 1.0;
    this.ans_activity_factor = 1.0;
    this.target_minute_volume = 0.4;
    this.target_tidal_volume = 16.0;

    // dependent properties
    this.resp_rate = 40.0;
    this.resp_signal = 0.0;
  ...
  calc_model() {
    ...
    this.target_minute_volume =
      (_minute_volume_ref + (this.mv_ans_factor - 1.0) * _minute_volume_ref) *
