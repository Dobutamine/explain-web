export class GasResistor {
  ...
  calc_model() {
      ...
      if (this.flow > 0) {
          ...
          // Transfer the remaining volume to the other model component
          this._model_comp_to.volume_in(
              this.flow * this._t - vol_not_removed, this._model_comp_from
          );
      } else if (this.flow < 0) {
          ...
          this._model_comp_from.volume_in(
              -this.flow * this._t - vol_not_removed, this._model_comp_to
          );
      }
  }
