...
export class Ecls {
  ...
  calc_model() {
      ...
      if (this._update_counter > this._update_interval) {
          ...
          this.drainage_cannula_diameter = (this.drainage_cannula_size * 0.33) / 1000.0;
          ...
          this._oxy_tubing_out.r_for = this.oxy_resistance * this.oxy_resistance_factor;
          this._oxy_tubing_out.r_back = this.oxy_resistance * this.oxy_resistance_factor;

          if (this.sweep_gas > 0.0) {
              this._gas_in_oxy.r_for = (this._gas_in.pres - this.pres_atm) / (this.sweep_gas / 60.0);
          }
  ...
  build_tubing_in() {
      ...
      this.tubing_diameter = this.tubing_size * 0.0254;
      const tubing_in_uvol = this.calc_volume(this.tubing_in_length, this.tubing_diameter);
  ...
  build_tubing_out() {
      ...
      this.tubing_diameter = this.tubing_size * 0.0254;
      const tubing_out_uvol = this.calc_volume(this.tubing_out_length, this.tubing_diameter);
  ...
  build_oxy() {
      ...
      this.tubing_diameter = this.tubing_size * 0.0254;
      const bridge_uvol = this.calc_volume(this.tubing_in_length / 2.0, this.tubing_diameter);
  ...
  build_blood_part() {
      ...
      const drainage_res = this.calc_resistance_tube(this.drainage_cannula_diameter, this.drainage_cannula_length);
      const return_res = this.calc_resistance_tube(this.return_cannula_diameter, this.return_cannula_length);
  ...
  set_fio2(new_fio2) {
      ...
      set_gas_composition(this._gas_in, this.fio2_gas, this.temp_gas, this.humidity_gas);
  }
  ...
  set_co2_flow(new_co2_flow) {
      ...
      set_gas_composition(this._gas_in, this.fio2_gas, this.temp_gas, this.humidity_gas, this.fico2_gas);
  }
  ...
  build_gas_part() {
      ...
      set_gas_composition(this._gas_oxy, this.fio2_gas, this.temp_gas, this.humidity_gas);
  ...
  calc_resistance_tube(diameter, length, viscosity = 6.0) {
      ...
      let res = (8.0 * n_pas * length_meters) / (Math.PI * Math.pow(radius_meters, 4));
