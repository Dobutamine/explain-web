<template>
  <q-card class="q-pb-xs q-pt-xs q-ma-sm" bordered>
    ...
    <div
      v-if="isEnabled && ventilator_running"
    ...
    >
      ...
      <div
        v-if="(mode == 'PRVC' || mode == 'VC') && mode != 'HFOV'"
...
export default {
  ...
  methods: {
    ...
    set_trigger() {
      if (this.update_model) {
        explain.callModelFunction("Ventilator.set_trigger_perc", [
          parseFloat[this.trigger_perc],
        ]);
      }
    },
    set_fio2() {
      if (this.update_model) {
        explain.callModelFunction("Ventilator.set_fio2", [
          parseFloat(this.fio2),
        ]);
      }
    },
    set_temp() {
      if (this.update_model) {
        explain.callModelFunction("Ventilator.set_temp", [
    ...
    set_humidity() {
      if (this.update_model) {
        explain.callModelFunction("Ventilator.set_humidity", [
          parseFloat(this.humidity / 100.0),
        ]);
      }
    },
    update_hfo() {
      explain.callModelFunction("Ventilator.set_ventilator_hfov", [
        this.hfo_map_cmh2o,
        this.hfo_freq,
        this.hfo_amplitude_cmh2o,
        this.hfo_bias_flow,
      ]);
    },
      ...
      if (this.update_model) {
        switch (this.mode) {
          ...
          case "PC":
            ...
            if (this.ventilator_running) {
              explain.callModelFunction("Ventilator.set_ventilator_pc", [
                this.pip_cmh2o,
                this.peep_cmh2o,
                this.freq,
                this.insp_time,
          ...
          case "PRVC":
            ...
            if (this.ventilator_running) {
              ...
              explain.callModelFunction("Ventilator.set_ventilator_prvc", [
                this.pip_cmh2o,
                this.peep_cmh2o,
                this.freq,
                this.tidal_volume,
          ...
          case "PS":
            ...
            if (this.ventilator_running) {
              explain.callModelFunction("Ventilator.set_ventilator_ps", [
                this.pip_cmh2o,
                this.peep_cmh2o,
                this.freq,
                this.insp_time,
          ...
          case "VC":
            ...
            if (this.ventilator_running) {
              this.pip_caption = "pip max";
              explain.callModelFunction("Ventilator.set_ventilator_vc", [
                this.pip_cmh2o,
                this.peep_cmh2o,
                this.freq,
                this.tidal_volume,
    ...
    processModelState() {
      if (explain.modelState.models) {
        this.ventilator_running =
          explain.modelState.models["Ventilator"].vent_running;
        if (this.ventilator_running) {
        ...
        this.et_tube_diameter =
          explain.modelState.models["Ventilator"].ettube_diameter;
        this.et_tube_length =
          explain.modelState.models["Ventilator"].ettube_length;
        this.temp = explain.modelState.models["Ventilator"].temp;
        this.humidity =
          explain.modelState.models["Ventilator"].humidity * 100.0;
        ...
        this.tidal_volume =
          explain.modelState.models["Ventilator"].tidal_volume * 1000.0;
        this.fio2 = explain.modelState.models["Ventilator"].fio2 * 100.0;
        this.trigger_perc =
          explain.modelState.models["Ventilator"].trigger_volume_perc;
        this.hfo_amplitude_cmh2o =
          explain.modelState.models["Ventilator"].hfo_amplitude_cmh2o;
        this.hfo_map_cmh2o =
          explain.modelState.models["Ventilator"].hfo_map_cmh2o;
        this.hfo_freq = explain.modelState.models["Ventilator"].hfo_freq;
        this.hfo_bias_flow =
          explain.modelState.models["Ventilator"].hfo_bias_flow;
        this.spont_breathing =
          explain.modelState.models["Breathing"].breathing_enabled;
      }
    },
  },
  mounted() {
