<template>
  <q-card class="q-pb-xs q-pt-xs q-ma-sm" bordered>
    ...
    <div
      v-if="advancedEnabled && isEnabled"
      class="q-mt-sm text-overline justify-center q-gutter-xs row"
    >
      <div>
        <q-toggle
      ...
      if (this.update_model) {
        switch (this.mode) {
          ...
          case "PC":
            ...
            if (this.ventilator_running) {
              explain.callModelFunction("Ventilator.set_pc", [
                this.pip_cmh2o,
                this.peep_cmh2o,
                this.freq,
                this.insp_time,
          ...
          case "PRVC":
            ...
            if (this.ventilator_running) {
              ...
              explain.callModelFunction("Ventilator.set_prvc", [
                this.pip_cmh2o,
                this.peep_cmh2o,
                this.freq,
                this.tidal_volume,
          ...
          case "PS":
            ...
            if (this.ventilator_running) {
              explain.callModelFunction("Ventilator.set_ps", [
                this.pip_cmh2o,
                this.peep_cmh2o,
                this.freq,
                this.insp_time,
    ...
    processModelState() {
      if (explain.modelState.models) {
        this.ventilator_running =
          explain.modelState.models["Ventilator"].is_enabled;
        if (this.ventilator_running) {
