...
export default {
  setup() {
    ...
    let graph_fill = false
    let p1_color = ref("rgb(192, 0, 0, 1.0)");
    let p1_color_background = ref("rgb(192, 0, 0, 0.3)");

    let p2_color = ref("rgb(0, 192, 0, 1.0)");
    let p2_color_background = ref("rgb(0, 192, 0, 0.3)");

    let p3_color = ref("rgb(0, 192, 192, 1.0)");
    let p3_color_background = ref("rgb(0, 192, 192, 0.3)");

    let p4_color = ref("rgb(192, 0, 192, 1.0)");
    let p4_color_background = ref("rgb(0, 192, 0, 0.3)");

    let p5_color = ref("rgb(192, 192, 0, 1.0)");
    let p5_color_background = ref("rgb(0, 192, 0, 0.3)");

    let p6_color = ref("rgb(0, 192, 192, 1.0)");
    let p6_color_background = ref("rgb(0, 192, 0, 0.3)");

    let p7_color = ref("rgb(192, 192, 192, 1.0)");
    let p7_color_background = ref("rgb(0, 192, 0, 0.3)");
      ...
      datasets: [
        {
          data: [],
          fill: graph_fill,
          backgroundColor: p1_color_background,
        ...
        },
        {
          data: [],
          fill: graph_fill,
          backgroundColor: p2_color_background,
        ...
        },
        {
          data: [],
          fill: graph_fill,
          backgroundColor: p3_color_background,
      ...
      datasets: [
        {
          ...
          fill: graph_fill,
          backgroundColor: p5_color_background,
          borderWidth: 1,
          pointStyle: false,
        },
        {
          ...
          fill: graph_fill,
          backgroundColor: p6_color_background,
          borderWidth: 1,
          pointStyle: false,
        },
      ],
      ...
      datasets: [
        {
          ...
          fill: graph_fill,
          backgroundColor: p4_color_background,
          borderWidth: 1,
          pointStyle: false,
        },
        {
          ...
          fill: graph_fill,
          backgroundColor: p7_color_background,
          borderWidth: 1,
          pointStyle: false,
        },
      ],
  ...
  methods: {
    ...
    analyzeData() {
      ...
      if (this.p2 !== "") {
        param2 = explain.modelData.map((item) => {
          return item[this.p2] * this.chart2_factor;
        });
      ...
      if (this.p3 !== "") {
        param3 = explain.modelData.map((item) => {
          return item[this.p3] * this.chart3_factor;
        });
      ...
      if (this.p4 !== "") {
        param4 = explain.modelData.map((item) => {
          return item[this.p4] * this.chart4_factor;
        });
      ...
      if (this.p5 !== "") {
        param5 = explain.modelData.map((item) => {
          return item[this.p5] * this.chart5_factor;
        });
      ...
      if (this.p6 !== "") {
        param6 = explain.modelData.map((item) => {
          return item[this.p6] * this.chart6_factor;
        });
      ...
      if (this.p7 !== "") {
        param7 = explain.modelData.map((item) => {
          return item[this.p7] * this.chart7_factor;
        });
    ...
    dataUpdate() {
      ...
      if (this.p2 !== "") {
        this.y2_axis = explain.modelData.map((item) => {
          return item[this.p2] * this.chart2_factor;
        });
        data_set_pres.push({
          data: this.y2_axis,
      ...
      if (this.p3 !== "") {
        this.y3_axis = explain.modelData.map((item) => {
          return item[this.p3] * this.chart3_factor;
        });
        data_set_pres.push({
          data: this.y3_axis,
      ...
      let data_set_flow = [];
      if (this.p5 !== "") {
        this.y5_axis = explain.modelData.map((item) => {
          return item[this.p5] * this.chart5_factor;
        });
        data_set_flow.push({
          data: this.y5_axis,
      ...
      if (this.p6 !== "") {
        this.y6_axis = explain.modelData.map((item) => {
          return item[this.p6] * this.chart6_factor;
        });
        data_set_flow.push({
          data: this.y6_axis,
      ...
      let data_set_vol = [];
      if (this.p4 !== "") {
        this.y4_axis = explain.modelData.map((item) => {
          return item[this.p4] * this.chart4_factor;
        });
        data_set_vol.push({
          data: this.y4_axis,
      ...
      if (this.p7 !== "") {
        this.y7_axis = explain.modelData.map((item) => {
          return item[this.p7] * this.chart7_factor;
        });
        data_set_vol.push({
          data: this.y7_axis,
    ...
    exportData() {
      let header = "";
      let data = {
        time: explain.modelData.map((item) => {
          return item["time"];
        }),
      };
      ...
      if (this.p1 !== "") {
        let h1 =
          this.selectedModel1.toUpperCase() +
          this.selectedProp1.toUpperCase() +
          "_";
        header += h1;
        data[h1] = explain.modelData.map((item) => {
          return parseFloat(item[this.p1]).toFixed(5);
        });
      }
      if (this.p2 !== "") {
        let h2 =
          this.selectedModel2.toUpperCase() +
          this.selectedProp2.toUpperCase() +
          "_";
        header += h2;
        data[h2] = explain.modelData.map((item) => {
          return parseFloat(item[this.p2]).toFixed(5);
        });
      }
      if (this.p3 !== "") {
        let h3 =
          this.selectedModel3.toUpperCase() + this.selectedProp3.toUpperCase();
        header += h3;
        data[h3] = explain.modelData.map((item) => {
          return parseFloat(item[this.p3]).toFixed(5);
        });
      }
      if (this.p4 !== "") {
        let h4 =
          this.selectedModel4.toUpperCase() + this.selectedProp4.toUpperCase();
        header += h4;
        data[h4] = explain.modelData.map((item) => {
          return parseFloat(item[this.p4]).toFixed(5);
        });
      }
      if (this.p5 !== "") {
        let h5 =
          this.selectedModel5.toUpperCase() + this.selectedProp5.toUpperCase();
        header += h5;
        data[h5] = explain.modelData.map((item) => {
          return parseFloat(item[this.p5]).toFixed(5);
        });
      }
      if (this.p6 !== "") {
        let h6 =
          this.selectedModel6.toUpperCase() + this.selectedProp6.toUpperCase();
        header += h6;
        data[h6] = explain.modelData.map((item) => {
          return parseFloat(item[this.p6]).toFixed(5);
        });
      }
      if (this.p7 !== "") {
        let h7 =
          this.selectedModel7.toUpperCase() + this.selectedProp7.toUpperCase();
        header += h7;
        data[h7] = explain.modelData.map((item) => {
          return parseFloat(item[this.p7]).toFixed(5);
        });
      }
