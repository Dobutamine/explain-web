  ...
  <q-card class="q-pb-xs q-pt-xs q-ma-sm" bordered>
    ...
    <div v-if="isEnabled">
      <div class="row text-overline justify-center">
        <div class="col text-center">Ductus arteriosus resistance = {{ thorax_compliance * 10.0 }}</div>
      </div>
      <div class="row text-overline justify-center">
      ...
      <div class="row text-overline justify-center">
        <div class="col text-center">Foramen ovale resistance = {{ lungs_compliance * 10.0 }}</div>
      </div>
      <div class="row text-overline justify-center">
      ...
      <div class="row text-overline justify-center">
        <div class="col text-center">Pulmonary AV shunting = {{ upper_airway_resistance * 10.0 }}</div>
      </div>
      <div class="row text-overline justify-center">
