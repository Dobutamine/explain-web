  ...
  <q-card class="q-pb-xs q-pt-xs q-ma-sm" bordered>
    ...
    <div v-if="!collapsed">
      <div class="q-ml-md q-mr-sm q-mb-sm text-overline justify-center">
        <div
          class="text-center"
          @click="generalSettingsCollapsed = !generalSettingsCollapsed"
        >
          general settings
        </div>
        <div
          v-if="!generalSettingsCollapsed"
          class="q-ma-sm row justify-center"
        >
          <q-toggle
            class="col-6"
            v-model="state.diagram_definition.settings.grid"
            label="grid"
            dense
            dark
            size="sm"
          ...
          <q-input
            class="col-6"
            v-model.number="state.diagram_definition.settings.gridSize"
            type="number"
            :min="5"
            :max="100"
            :step="1"
        ...
        <div v-if="!generalSettingsCollapsed" class="q-ma-sm row">
          <q-toggle
            v-model="state.diagram_definition.settings.skeleton"
            label="skeleton"
            dense
            dark
            size="sm"
        ...
        <div
          v-if="
            state.diagram_definition.settings.skeleton &&
        ...
        >
          <q-input
            class="col-4"
            v-model.number="state.diagram_definition.settings.xOffset"
            label="x-offset"
            type="number"
            :min="-1000"
            :max="1000"
          ...
          <q-input
            class="col-4"
            v-model.number="state.diagram_definition.settings.yOffset"
            label="y-offset"
            type="number"
            :min="-1000"
            :max="1000"
          ...
          <q-input
            class="col-4"
            v-model.number="state.diagram_definition.settings.radius"
            label="radius"
            dense
            dark
            type="number"
        ...
        <div v-if="!generalSettingsCollapsed" class="q-ma-sm row">
          <q-input
            class="col-6"
            v-model.number="state.diagram_definition.settings.scaling"
            label="scaling"
            dense
            dark
            type="number"
          ...
          <q-input
            class="col-6"
            v-model.number="state.diagram_definition.settings.speed"
            label="speed"
            dense
            dark
            type="number"
        ...
        <div v-if="!generalSettingsCollapsed" class="q-ma-sm row">
          <q-toggle
            v-model="state.diagram_definition.settings.shuntOptionsVisible"
            label="shunt and ecls options"
            dense
            dark
            size="sm"
            @update:model-value="updateDiagram"
        ...
        >
          ...
          >
          <q-btn
            v-if="this.state.prev_diagram_definition"
            class="col q-ma-sm"
            color="secondary"
            size="sm"
            @click="restore_diagram"
            >RESTORE DIAGRAM</q-btn
          >
        </div>
      </div>
      ...
      <div
        ...
        @click="componentSettingsCollapsed = !componentSettingsCollapsed"
      >
        component settings
      </div>
      <div
        v-if="!componentSettingsCollapsed"
        class="q-ml-md q-mr-sm q-mb-sm row text-overline justify-center"
      >
        <q-select
          class="col-9"
          v-model:model-value="selectedDiagramComponentName"
          :options="Object.keys(state.diagram_definition.components)"
          label="diagram component"
          dense
          @update:model-value="editComponent"
        ></q-select>
        <q-btn
          color="secondary"
          label="ADD NEW"
          dark
          class="q-ma-sm q-mt-md col"
          dense
          size="sm"
        >
          <q-menu dark>
      ...
      <div v-if="!componentSettingsCollapsed">
        ...
        <div
          ...
          class="q-gutter-sm row text-overline justify-center q-mb-md q-mt-xs"
        >
          <q-btn
            color="secondary"
            dense
  ...
  methods: {
    restore_diagram() {
      if (this.state.prev_diagram_definition) {
        this.state.diagram_definition = JSON.parse(
          JSON.stringify(this.prev_diagram_definition)
        );
        this.$bus.emit("rebuild_diagram");
      }
    },
    clearDiagram() {
      this.prev_diagram_definition = JSON.parse(
        JSON.stringify(this.state.diagram_definition)
      );
    ...
    getAllDiagramComponents() {
      ...
      if (this.state.diagram_definition.components) {
        Object.keys(this.state.diagram_definition.components).forEach(
          (component) => {
    ...
    deleteComponentFromStore() {
      ...
      let compType =
        this.state.diagram_definition.components[this.compName].compType;
      if (
        compType === "GasCompartment" ||
        compType === "BloodCompartment" ||
        compType === "BloodPump" ||
    ...
    findDiagramComponents(compType) {
      Object.keys(this.state.diagram_definition.components).forEach(
        (compName) => {
          if (
            this.state.diagram_definition.components[compName].compType ==
            compType
          ) {
